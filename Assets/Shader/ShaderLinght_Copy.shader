...
Shader "Noriben/LaserLight_Copy"
{
    Properties
    {
        [Header(Color)]
        ...
        //insert~
        //[Toggle(AudioLinkSyncOn)] _AudioLinkSyncOn ("AudioLinkSync On", Float) = 0
        _AudioLinkSync("AudioLink Sync", Range(0, 1)) = 0
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                //_AudioLink
					...
					float AudioLink = _AudioLinkSync;
